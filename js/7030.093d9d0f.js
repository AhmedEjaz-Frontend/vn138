  ...
  [7030],
  {
    10200: (e, i, t) => {
      ...
      i.default = (e) => {
        let {
          loginCalendarData: i,
          isShowMissionFeature: t,
          isShowVipReceive: s,
          closeModal: h,
          updateVipSiginBounsMethods: w,
        } = e;
        const { newVipSignIn: S } = i,
          ...
          { vipReceiveMessage: E, vipReceiveStyle: M } = (0, n.useCallback)(
            (0, c.getVipReceiveInfo)(N),
            [N]
          ),
          V = (0, o.useHistory)();
        return (
            ...
            (0, g.jsxs)("div", {
              ...
              children: [
                s &&
                  (0, g.jsx)("div", {
                    className: (0, r.default)(
                      `calendar-feature-modal-box ${p.isMobile ? M : ""}`,
                      {
                        h100: j && p.isDesktop,
                      },
                      {
                          ...
                          children: [
                            ...
                            (0, g.jsx)("div", {
                              ...
                              children: (0, g.jsx)(m.default, {
                                className: M,
                                onClick: () => {
                                  N === l.vipReceiveTypeEnum.PENDING &&
                                    (_({
                                      isLoading: !0,
                                    }),
                                    w().finally(() => {
                ...
                t &&
                  (0, g.jsxs)("div", {
                    className: (0, r.default)(
                      "calendar-feature-modal-box mission",
                      {
                        h100: x && p.isDesktop,
                      },
                      {
                    ...
                    children: [
                      (0, g.jsx)("i", {
                        className:
                          "calendar-feature-modal-box-icon icon-mission",
                      }),
                      (0, g.jsx)("div", {
                        className: "btn",
                        children: (0, g.jsx)(v.default, {
                          onClick: () => {
                            V.push(u.paths.MISSION), h();
                          },
                          children: (0, g.jsx)("p", {
    ...
    17030: (e, i, t) => {
      ...
      const I = new Date().getMonth() + 1,
        ...
        x = I - 2 <= 0 ? 10 + I : I - 2,
        R = {
          toOpenGift: "../images/reward/gift.svga",
          openingGift: "../images/reward/gift-open.svga",
          giftLoop: "../images/reward/gift-loop.svga",
        },
        ...
        E = n.default.memo(function (e) {
          ...
          const E = d.default.weekdaysMin() || [
            ...
            G = (0, a.useDispatch)(),
            A = (0, _.default)(),
            F = (0, m.formatDateTime)(
              new Date(
                (0, m.convertDateTime)(new Date().getTime(), {
                  timeZone: 8,
                })
              ),
              "YYYY/MM/DD"
            ...
            Y = (e) =>
              Number(
                `${e.split("/")[0]}${(0, u.default)(e.split("/")[1]).format(
                  "00"
                )}`
              ),
            ...
            H = (0, n.useMemo)(() => {
              const { year: e, month: i } = $,
                t = ((e, i) =>
                  (0, d.default)(`${e}-${i}`, "MM-YYYY").daysInMonth())(i, e),
                s = ((e, i) =>
                  Number(
                    (0, d.default)(`${e}-${i}`, "MM-YYYY")
                      .startOf("month")
                      .format("d")
                  ))(i, e);
              return Array(t + s)
            ...
            Z = (e) => {
              if (t) return !1;
              if (null == M || !M.newVipSignIn) return !1;
            ...
            q = (e) => {
              if (null == M || !M.newVipSignIn) return null;
              const { newVipSignIn: i } = M,
                { signInDates: t } = i,
                s = Y(e),
                n = t.map((e) => B(e)),
                      ...
                      "div",
                      {
                        ...
                        children: [
                          ...
                          (0, N.jsx)("span", {
                            children:
                              "amount" === e
                                ? v.defaultCurrencyI18n
                                : f.i18n["activity.points"],
                          }),
                        ],
                      },
                      e
          ...
          (0, n.useEffect)(() => {
            (k.amount.length > 0 || k.activityPoints.length > 0) &&
              b.isShowGiftLoopReady &&
              (X("giftLoop"),
              T({
                isShowGiftLoopReady: !1,
              }));
            ...
            (0, l.default)(() => {
              t && s
                ...
                : ((() => {
                        ...
                        (e[i] = ((e) => {
                          ...
                          return new Promise((t, s) => {
                            i.load(
                              ...
                              (i) => {
                                console.log(`load svga error : ${e}`), s(i);
                              }
                            );
                          });
                        })(i)),
                  ...
                  (0, h.getLoginCalendar)()
                    .then((e) => {
                      let { payload: i } = e;
                      V(i),
                        i.mission.recordIds.length > 0 &&
                          setTimeout(() => {
                            T({
                              isShowSvga: !0,
                            });
          ...
          const te = {
              ...
              updateVipSiginBounsMethods: () => {
                if (b.isShowVipReceive)
                  return new Promise((e, i) => {
                    G((0, w.updateVipSiginBouns)()).finally(() => {
                      (0, h.getLoginCalendar)().then((i) => {
                        let { payload: t } = i;
                        V({
                          ...t,
                        }),
            ...
            { continuousLogin: se, accumulateLogin: ne } =
              (null == M ? void 0 : M.mission) || {};
                      ...
                      (0, N.jsxs)("div", {
                        ...
                        children: [
                          !!se &&
                            (0, N.jsxs)("span", {
                              children: [
                                f.i18n["mission.type.PERIOD_CONTINUOUS_LOGIN"],
                                ": ",
                                se,
                              ],
                            }),
                          !!ne &&
                            (0, N.jsxs)("span", {
                              children: [
                                f.i18n["mission.type.ACCUMULATE_LOGIN"],
                                ": ",
                                ne,
                              ],
                            }),
    ...
    44168: (e, i, t) => {
      ...
      (i.getVipReceiveInfo = (e) => {
        ...
        (i.getVipLevelName = function (e) {
          ...
          return e === n.VIPLevelsEnum.BLACKLIST
            ? a.i18n["new.vip.none"]
            : `${i && a.i18n["new.vip"]}${e}`;
        });
    },
    ...
    68183: (e, i, t) => {
      ...
      (i.getVipSetting = () => ({
        ...
        (i.claimVipPlayerReward = (e) => ({
          types: [
            r.PUT_VIP_PLAYER_REWARD_REQUEST,
            r.PUT_VIP_PLAYER_REWARD_SUCCESS,
            r.PUT_VIP_PLAYER_REWARD_FAILURE,
          ],
          promises: [
            () =>
              (0, n.default)({
        ...
        (i.updateVipSiginBouns = () => ({
          types: [
            r.PUT_UPDATE_VIP_SIGIN_BOUNS_REQ,
            r.PUT_UPDATE_VIP_SIGIN_BOUNS_SUC,
        ...
        (i.getVipLevelInfo = () => ({
          types: [
            r.GET_VIP_LEVEL_INFO_REQUEST,
            r.GET_VIP_LEVEL_INFO_SUCCESS,
            r.GET_VIP_LEVEL_INFO_FAILURE,
          ],
          promises: [
            () =>
              (0, n.default)({
