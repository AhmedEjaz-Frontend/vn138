          ...
          return (
            ...
            h(e, [
              ...
              },
              {
                ...
                value: function (t) {
                  var e, r;
                  (null === (e = this.props.imageSettings) || void 0 === e
                    ? void 0
                    : e.src) !==
                    (null === (r = t.imageSettings) || void 0 === r
                      ? void 0
                      : r.src) &&
                    this.setState({
                      imgLoaded: !1,
          ...
          h(e, [
            {
              ...
              value: function () {
                ...
                null != l &&
                  null != p &&
                  (null != p.excavation && (c = L(c, p.excavation)),
                  (m = v.createElement("image", {
                    xlinkHref: l.src,
                    height: p.h,
                    width: p.w,
                    x: p.x + g,
        ...
        (s.createBytes = function (t, e) {
          ...
          for (c = 0; c < n; c++)
            for (l = 0; l < e.length; l++)
              c < i[l].length && (v[y++] = i[l][c]);
          for (c = 0; c < o; c++)
            for (l = 0; l < e.length; l++)
              c < s[l].length && (v[y++] = s[l][c]);
          return v;
        }),
        (t.exports = s);
    },
