    ...
    39125: (e, t, r) => {
      ...
      var o,
        ...
        x = function (e) {
          ...
          var n = R(e, "defaultTitle");
          return t || n || void 0;
        },
        I = function (e) {
          return R(e, "onChangeClientState") || function () {};
        },
        M = function (e, t) {
          return t
            .filter(function (t) {
              ...
              r.filter(function (e) {
                for (
                  ...
                  var u = i[a],
                    c = u.toLowerCase();
                  -1 === t.indexOf(c) ||
                    (r === w && "canonical" === e[r].toLowerCase()) ||
                    (c === w && "stylesheet" === e[c].toLowerCase()) ||
                    (r = c),
                    -1 === t.indexOf(u) ||
                      (u !== v && u !== m && u !== g) ||
                      (r = u);
        ...
        V = function (e, t) {
          ...
          if (r) {
            ...
            o.length === i.length
              ? r.removeAttribute(S)
              : r.getAttribute(S) !== a.join(",") &&
                r.setAttribute(S, a.join(","));
          }
        },
        W = function (e, t) {
              ...
              t.forEach(function (t) {
                ...
                for (var n in t)
                  if (t.hasOwnProperty(n))
                    if (n === v) r.innerHTML = t.innerHTML;
                    else if (n === m)
                      r.styleSheet
        ...
        X = s(
          function (e) {
            return {
              ...
              defer: R(e, "defer"),
              encode: R(e, "encodeSpecialCharacters"),
              htmlAttributes: M(y, e),
              linkTags: _(h.LINK, [w, T], e),
              metaTags: _(h.META, ["name", b, "http-equiv", "property", g], e),
              noscriptTags: _(h.NOSCRIPT, [v], e),
              onChangeClientState: I(e),
              scriptTags: _(h.SCRIPT, ["src", v], e),
              styleTags: _(h.STYLE, [m], e),
              title: x(e),
                ...
                (t.prototype.flattenArrayTypeChildren = function (e) {
                  ...
                  return P(
                    ...
                    (((t = {})[r.type] = [].concat(n[r.type] || [], [
                      P({}, o, this.mapNestedChildrenToProps(r, i)),
                    ])),
                    t)
                  );
                }),
